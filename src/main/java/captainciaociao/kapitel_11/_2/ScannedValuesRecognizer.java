...
public class ScannedValuesRecognizer {
    ...
    private static String reduceString(String input) {
        String reducedString = input.replaceAll("[ ]+", "").replaceAll("000", "0").replaceAll("11", "1")
                .replaceAll("22", "2").replaceAll("333", "3").replaceAll("44", "4").replaceAll("5555", "5")
                .replaceAll("77777", "7").replaceAll("888", "8").replaceAll("9999", "9");
    ...
    public enum NumberSubstrings {
        ZERO("000"), ONE("11"), TWO("22"), THREE("333"), FOUR("4  4"), FIFE("5555"), SIX("6"),
        SEVEN("77777"), EIGHT("888"), NINE("9999");

        private String numberString;

        private NumberSubstrings(String numberString) {
